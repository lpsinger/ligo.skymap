...
root1.attrib["lines-covered"] = str(
    int(root1.attrib["lines-covered"]) + int(root2.attrib["lines-covered"])
)
root1.attrib["lines-valid"] = str(
    int(root1.attrib["lines-valid"]) + int(root2.attrib["lines-valid"])
)
try:
    root1.attrib["line-rate"] = str(
        int(root1.attrib["lines-covered"]) / int(root1.attrib["lines-valid"])
    )
except ZeroDivisionError:
    root1.attrib["line-rate"] = "0"
root1.attrib["branches-covered"] = str(
    int(root1.attrib["branches-covered"]) + int(root2.attrib["branches-covered"])
)
root1.attrib["branches-valid"] = str(
    int(root1.attrib["branches-valid"]) + int(root2.attrib["branches-valid"])
)
try:
    root1.attrib["branch-rate"] = str(
        int(root1.attrib["branches-covered"]) / int(root1.attrib["branches-valid"])
    )
except ZeroDivisionError:
