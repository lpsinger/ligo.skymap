...
from ligo.skymap.postprocess.cosmology import dVC_dVL_for_DL, z_for_DL
...
print(*(f"\t{c:+.8e}" for c in log_dVC_dVL), sep=",\n")
print("};")
print(f"static const double dVC_dVL_tmin = {log_DL[0]:.15f};")
print(f"static const double dVC_dVL_tmax = {log_DL[-1]:.15f};")
print(f"static const double dVC_dVL_dt = {np.diff(log_DL)[0]:.15f};")
print(f"static const double dVC_dVL_high_z_slope = {high_z_slope:.15f};")
print(f"static const double dVC_dVL_high_z_intercept = {high_z_intercept:.15f};")
...
print(*(f"\t{c:+.8e}" for c in DL), sep=",\n")
print("};")
print("static const double dVC_dVL_test_y[] = {")
print(*(f"\t{c:+.8e}" for c in dVC_dVL), sep=",\n")
print("};")
